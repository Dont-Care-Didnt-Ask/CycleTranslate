...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--model_name", default="Helsinki-NLP/opus-mt-en-ru", help="Model name to load from huggingface.")
    ...
    print("Tokenizing...")
    tokenizer = transformers.AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-ru-en")
    tokenized_data = {
    ...
    for flip_direction in (False, True):
        ...
        # Defining model
        model = transformers.AutoModelForSeq2SeqLM.from_config(transformers.AutoConfig.from_pretrained(
            "Helsinki-NLP/opus-mt-en-ru" if not flip_direction else "Helsinki-NLP/opus-mt-ru-en"
        )).to(device)
